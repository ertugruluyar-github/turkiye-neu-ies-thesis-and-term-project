// TODO: Denklem figürü örneği ekle.
...
#figure(
  ...
  ```,
) <figür-denklem-denklem-örneği>

@figür-denklem-denklem-örneği'de R programlama dilinde yazılan ```r hello_world()``` fonksiyonu konsola `Hello World!` yazdırır.
