...
<details>
  ...
  #import "@preview/utype-neuies-reports:1.0.1": (
  ...
  // NOT: Yukarıdaki durumlarda olduğu gibi içe aktarılan değişkenleri tek tek belirtmek yerine `#import "@preview/utype-neuies-reports:1.0.1": *` şeklinde tüm değişkenleri içe aktararak da yapabilirsiniz.
...
<details>
  ...
  ```typst
  #import "@local/utype-neuies-reports:1.0.1": (
    template-configurations,
    LANGUAGES,
    REPORT-TYPES,
    DEPARTMENTS,
  ...
  // NOT: Yukarıdaki durumlarda olduğu gibi içe aktarılan değişkenleri tek tek belirtmek yerine `#import "@local/utype-neuies-reports:1.0.1": *` şeklinde tüm değişkenleri içe aktararak da yapabilirsiniz.
  ```
...
<details>
  ...
  // NOTE: As in the above cases, instead of specifying the imported variables individually, you can also do it by importing all variables as `#import "@preview/utype-neuies-reports:1.0.1": *`.
...
<details>
  ...
  // NOTE: As in the above cases, instead of specifying the imported variables individually, you can also do it by importing all variables as `#import "@local/utype-neuies-reports:1.0.1": *`.
  ```
